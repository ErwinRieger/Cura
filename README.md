...
This fork adds a *Print Ultimaker2 UltiGCode over USB* functionality to Cura. It is intended to work together with the custom UM2 firmware [Ultimaker2Marlin-USBPrint](https://github.com/ErwinRieger/Ultimaker2Marlin-USBPrint).
